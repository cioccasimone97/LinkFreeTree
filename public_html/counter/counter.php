...
function view_count(){
	...
	$counter_expire = 300; //time until expire in s
	$counter_filename = $_SERVER['DOCUMENT_ROOT'].'/counter/counter.txt';
	...
	$ret= " Online » ".$online." || Day » ".$day." || Week » ".$week." || Month » ".$month." || All » ".$all;
